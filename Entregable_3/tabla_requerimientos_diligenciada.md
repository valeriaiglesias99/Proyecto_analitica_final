...
| Datos | Q2 | El prototipo debe construirse sobre la ventana común validada entre las fuentes. | Revisión de ETL y reporte de calidad. | Ventana de 3 meses históricos documentada y reproducible, con validación temporal sobre las últimas 2 semanas y backtesting rolling. | ✅ Cubierto | La ventana de datos cubre de diciembre 2025 a marzo 2026. Para el modelado se usaron enero a marzo de 2026. Todo el proceso es reproducible ejecutando el notebook de principio a fin, y el dataset tiene su hash MD5 documentado para garantizar que siempre se trabaja con la misma versión de los datos. |
