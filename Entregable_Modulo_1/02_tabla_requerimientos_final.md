...
| Desempeño | D5 | El modelo debe identificar correctamente franjas críticas más allá del error promedio. | Clasificación binaria de franjas críticas vs no críticas sobre histórico. | Recall >= 0.80 y F1 >= 0.70 para franjas críticas. |
